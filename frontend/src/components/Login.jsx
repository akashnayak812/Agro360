                ...
                <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            type="button"
                            className="mt-4 w-full bg-white text-gray-900 font-bold py-3.5 rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center gap-2 hover:bg-gray-100"
                        >
